<?php
  ...
  */
  ...
  $receiving_email_address = 'contacto@laratatouille.cl';
  ...
  $book_a_table->subject = "Nuevo Pedido de ".$_POST['name'];
  ...
  */
  ...
  $book_a_table->add_message( $_POST['date'], 'Fecha del pedido', 4);
